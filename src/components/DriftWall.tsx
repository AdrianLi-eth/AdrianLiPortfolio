...
const DriftWall = ({
  ...
  const cssVars = useMemo<CSSProperties>(
    ...
    [tileWidth, tileHeight, gap, radius, lift, dim, overlayOpacity, grayscale, overlayColor, fade, perspective, maskStyle, style]
  );
  ...
  const imgClass = cx(
    ...
    '[filter:grayscale(var(--dw-gray))_saturate(1.06)_brightness(1.14)]',
    ...
    >
      ...
      {centerGlow > 0 ? (
        <div
          ...
          style={{
            background: `radial-gradient(ellipse 58% 68% at 50% 46%, rgba(255,255,255,${centerGlow}), transparent 72%)`,
            mixBlendMode: 'screen'
          }}
          aria-hidden
        />

...
function P({
  ...
  return (
    <p
      ...
      } ${medium ? 'font-bold text-paper-ink' : 'font-normal'}`}
    >
      {children}
    </p>
  )
        ...
        <article className="flex w-full flex-col gap-4 border border-line bg-paper pb-20 pt-16 sm:px-16 sm:pb-20 sm:pt-16 [font-family:'Noto_Sans_SC',sans-serif]">
          ...
          <div className="flex flex-col gap-6 px-4 sm:flex-row sm:px-0">
            ...
            <HighlightCard title="Result">
              <ol className="list-decimal space-y-0 pl-5 text-[15px] leading-[26px] text-paper-dim">
          ...
          {/* 1. Objective */}
          <div className="flex flex-col gap-4 px-4 pt-12 sm:px-0">
            <SectionTitle>1. Objective</SectionTitle>
            <P>
          ...
          {/* 2. Core UX Issues */}
          <div className="flex flex-col gap-5 px-4 pt-12 sm:px-0">
            <SectionTitle>2. Core UX Issues</SectionTitle>
            <div className="flex gap-2">
              <span className="w-7 shrink-0 text-[15px] font-bold leading-[1.75] text-paper-ink">
                1.
              </span>
          ...
          {/* 3. To Do */}
          <div className="flex flex-col gap-5 px-4 pt-12 sm:px-0">
            <SectionTitle>3. To Do</SectionTitle>
            <div className="w-full overflow-x-auto rounded border border-line">
              <table className="w-full min-w-[500px] border-collapse text-left text-[14px]">
                <thead>
                  <tr className="bg-surface-2">
                    <th className="w-[140px] border border-line px-4 py-3 font-bold text-paper-ink">
                      Priority
                    </th>
                    <th className="border border-line px-4 py-3 font-bold text-paper-ink">To Do</th>
                  </tr>
                </thead>
                <tbody>
                  {TODO_ROWS.map((row, i) => (
                    <tr key={i}>
                      <td className="border border-line px-4 py-3 font-bold text-paper-dim">
                        {row.priority}
                      </td>
                      <td className="border border-line px-4 py-3 text-paper-dim">{row.task}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {/* 4. User Data */}
          <div className="flex flex-col gap-10 px-4 pt-12 sm:px-0">
            <SectionTitle>4. User Data</SectionTitle>
                ...
                <table className="w-full min-w-[900px] border-collapse text-[13px]">
                  <thead>
                    <tr className="bg-surface-2">
                      ...
                      <th className="w-[32%] border border-line px-4 py-3 font-bold text-paper-ink">
                        Issues
                      </th>
                      <th className="w-[39%] border border-line px-4 py-3 font-bold text-paper-ink">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-line px-4 py-3 align-top text-paper-dim">
                    ...
                    <tr>
                      ...
                      <td className="border border-line px-4 py-3 align-top text-paper-dim">
                        <p className="mb-0 leading-[1.7]">Stock Trading Conversion Breakdown</p>
                        <p className="mb-0 leading-[1.7]">
                    ...
                    <tr>
                      ...
                      <td className="border border-line px-4 py-3 align-top text-paper-dim">
                        <p className="mb-0 leading-[1.7]">Weak Trading Signals</p>
                        <p className="mb-0 leading-[1.7]">
                      ...
                      <td className="border border-line align-top">
                        <WideImg
                          ...
                          className="max-w-[361px] border-0"
                        />
                      </td>
                    </tr>
                  </tbody>
          ...
          <div className="flex flex-col gap-8 px-4 pt-12 sm:px-0">
            <SectionTitle>Solution Exploration</SectionTitle>
